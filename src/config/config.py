...
class Config(_BaseConfig):
    ...
    def __init__(self) -> None:
        ...
        self._arg_trainer_stats = _Arg(type=str, help="Type of statistics to gather.", default="noop")
        self.trainer_stats_configs = trainer_stats_config.TrainerStatsConfigs()
        self._arg_data = _Arg(type=str, help="Dataset module to use to load data.", default="synthetic_whisper")
