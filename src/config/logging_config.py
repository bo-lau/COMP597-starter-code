...
class LoggingConfig(_BaseConfig):
    ...
    def __init__(self) -> None:
        ...
        level_choices = getattr(logging, 'getLevelNamesMapping', lambda: {"DEBUG": 10, "INFO": 20, "WARNING": 30, "ERROR": 40, "CRITICAL": 50})()
        self._arg_level = _Arg(type=str, help="Logging level.", default=self._default.level, choices=list(level_choices.keys()))
