...
| [`synthetic_whisper_milabench/`](./synthetic_whisper_milabench/) | `synthetic_whisper_milabench` | **In-memory Milabench pattern:** **`n = batch_size`** unique samples × `repeat` length; no training-time disk reads. |
