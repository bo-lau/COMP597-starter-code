...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/phase_time_bars_disk_w0_b32.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/resource_phases_disk_w0_b32.png}
...
Figure~\ref{fig:gpu_util} shows GPU utilization across batch sizes. GPU utilization is consistently above 95\% during steady-state training across all batch sizes, confirming that the workload is compute-bound on the RTX~A5000. Step~1 exhibits lower utilization ($\sim$1--6\%) due to CUDA JIT compilation and memory allocation, but this warm-up cost is amortized over the full training run.

\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/gpu_util_disk_w0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/gpu_cpu_util_mila_w0_b32.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/resources_disk_w0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/overhead_vs_noop_w0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figures/overhead_vs_noop_w4.png}
