...
% ============================================================
% All figures on a single page — uniform 2-column grid
% All PNGs share the same aspect ratio (10:6) so width alone
% produces equal-sized images.
% ============================================================
\newlength{\figw}\setlength{\figw}{0.48\textwidth}

\begin{figure*}[p]
\centering

\begin{minipage}[t]{\figw}
    \centering
